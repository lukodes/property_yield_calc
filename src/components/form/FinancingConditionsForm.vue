    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      <div class="space-y-2">
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          ...
          <input
            type="number"
            id="entryAmount"
            v-model="calculatorStore.entryAmount"
      ...
      <div class="space-y-2">
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          ...
          <input
            type="number"
            id="financingAmount"
            v-model="calculatorStore.financingAmount"
            class="input-field pl-10"
            placeholder="0,00"
            min="0"
            step="100"
      ...
      <div class="space-y-2">
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          ...
          <input
            type="number"
            id="monthlyPayment"
            v-model="calculatorStore.monthlyPayment"
            class="input-field pl-10"
            placeholder="0,00"
            min="0"
            step="100"
      ...
      <div class="space-y-2">
        ...
        <input
          type="number"
          id="financingTime"
          v-model="calculatorStore.financingTime"
          class="input-field"
          placeholder="360"
          min="12"
          max="480"
      ...
      <div class="space-y-2">
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          <input
            type="number"
            id="annualInterestRatePercentage"
            v-model="calculatorStore.annualInterestRatePercentage"
